...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-16 bg-charcoal-300 order-2 lg:order-1">
        <motion.div
        ...
        >
          ...
          <div className="mb-12">
            <h1 className="heading-3 text-ivory-100 mb-3">Create Account</h1>
            <p className="text-ivory-100/50 font-light">Join our fragrance house</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-ivory-100/40 hover:text-ivory-100/70 transition-colors"
                >
                  {showPassword ? (
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                required
                id="terms"
                className="mt-1 w-4 h-4 text-gold-300 bg-charcoal-50 border-ivory-100/20 rounded focus:ring-gold-300"
              />
              <label htmlFor="terms" className="text-xs text-ivory-100/50 font-light">
                I agree to the{' '}
                <Link to="#" className="text-gold-300 hover:text-gold-200 transition-colors">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link to="#" className="text-gold-300 hover:text-gold-200 transition-colors">
      ...
      <div className="hidden lg:block lg:w-1/2 relative order-1 lg:order-2">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-l from-charcoal-300/50 to-transparent" />
        ...
        <div className="absolute bottom-12 left-12 right-12">
          <p className="text-2xl font-serif text-ivory-100 italic leading-relaxed">
            "A fragrance is like a piece of jewelry, it becomes part of you."
          </p>
